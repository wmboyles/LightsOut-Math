...
\begin{abstract}
	...
	The thresholds explain the observed transitions for $a=21$ and $a=57$, and reduce previously observed mixed-prime formulas to small exact polynomial computations.
\end{abstract}
...
Thus the second range in the corresponding piecewise formula is $n\geq2$, not $n\geq1$.
...
\subsection{Further two-prime families}
