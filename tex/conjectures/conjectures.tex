...
also gives analytic all-level proofs for both known Wieferich primes.
More generally, for every prime $p>5$, either
$3\mid\operatorname{ord}_p(2)$ or
$v_2(\operatorname{ord}_p(2))=2$ implies
$d(p^k-1)=0$ for all $k\geq1$, without any restriction on Wieferich
depth.  The two cases include $3511$ and $1093$, respectively.
The remaining unresolved primes must therefore be Wieferich and satisfy
$3\nmid\operatorname{ord}_p(2)$ and
$v_2(\operatorname{ord}_p(2))\ne2$.
