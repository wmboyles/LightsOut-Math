...
\begin{document}
	...
	\end{lemma}
	\begin{proof}
		Notice that for any $v \in V$,
		\begin{equation*}
			\abs{\{N(v) \cap (V_1 \triangle V_2)\}} \equiv \abs{\{N(v) \cap V_1\}} + \abs{\{N(v) \cap V_2\}} \pmod 2.
		\end{equation*}
		So, we can write
		\begin{align*}
	...
	\begin{definition}
		Let $P$ be a polynomial in $\F_2[x]$.
		Then 
		\begin{equation*}
	...
	\begin{proof}
		...
		\end{align*}
		By lemma \ref{rankApparition}, if either rank-63 polynomials $C_2$ or $C_3$ divides $R_{m+1}(x)$, then 63 divides $m+1$.
		...
		\end{equation*}
		$P$ and $Q$ are closed under translation ($P(x+1) = Q(x)$), coprime to each other, and coprime with $C_1$.
	...
	\begin{definition}
		...
		\end{equation*}
	\end{definition}
	Although infinitely any Wieferich primes are conjectured to exist,
	...
	\begin{proof}
		...
		\begin{equation*}
			2^{p-1} - 1 = 2^{kn} - 1.
		\end{equation*}
		So, by the Lifting the Exponent lemma,
		\begin{equation*}
