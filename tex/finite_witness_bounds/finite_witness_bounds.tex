...
\begin{abstract}
	...
	For example, if 34 occurs, then it occurs for some $n\leq393197$.
\end{abstract}
...
\section{The candidate nullity 34}
...
\begin{remark}[Reduced computation]
	...
	The data through $n=100000$ checks the first 16,667 of them and
	finds none, leaving 16,100 targeted calculations.
\end{remark}
