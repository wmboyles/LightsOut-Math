...
\begin{document}
	...
	\begin{remark}
		The last two formulas were conjectured in \texttt{tex/conjectures/max\_nullity/max\_nullity.tex} of this repository, in the notation $g(b,k) = b\cdot 2^{k-1}-1$: $d(g(31,k)) = 5\cdot 2^{k+1}$ and $d(g(33,k)) = 11 \cdot 2^k - 2$.
